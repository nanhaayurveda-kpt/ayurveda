          ...
          <div className="space-y-3">
            {studentPackages.map((pkg) => {
              ...
              return (
                <div
                  key={pkg.id}
                  className={`border rounded-lg px-3 py-2.5 ${isSelected ? "border-green-400 bg-green-50" : "border-gray-200"}`}
                >
                  <div
      ...
      {selectedStudentId !== "" && studentPackages.length === 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-3">
          <p className="text-xs text-yellow-700">
            No fee package found. Add a package first from Fee Structure.
          </p>
        </div>
      )}
      ...
      {grossTotal > 0 && (
        <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-3 flex justify-between">
          <span className="text-sm font-medium text-green-700">
            Total ({selectedSemesters.length} year

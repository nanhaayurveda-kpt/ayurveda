          ...
          <div className="space-y-3">
            {studentPackages.map((pkg) => {
              ...
              return (
                <div
                  key={pkg.id}
                  className={`border rounded-xl overflow-hidden ${checked ? "border-green-400" : "border-gray-200"}`}
                >
                  <div
                    className={`px-3 py-2.5 flex items-center gap-3 cursor-pointer ${checked ? "bg-green-50" : "bg-white"}`}
                  ...
                  {checked && (
                    <div className="px-3 pb-3 pt-1 space-y-2 bg-green-50">
                      {FIXED_TYPES.map((ft) => {

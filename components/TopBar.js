    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-50 bg-green-900 shadow-md">
        <div className="max-w-2xl mx-auto flex items-center gap-2 px-4 py-2">
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="flex flex-col justify-center items-center gap-1 px-2 py-1.5 rounded-lg text-green-200 hover:bg-green-800 transition"
            aria-label="Menu"
          >
            <span className="block w-5 h-0.5 bg-green-200"></span>
            <span className="block w-5 h-0.5 bg-green-200"></span>
            <span className="block w-5 h-0.5 bg-green-200"></span>
          </button>
        ...
        {open && (
          <div className="max-w-2xl mx-auto px-4 pb-3 grid grid-cols-2 gap-1.5">
            ...
            <button
              onClick={handleLogout}
              className="col-span-2 flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-red-300 hover:bg-green-800 transition"
            >
              <span>🚪</span>
              <span>Logout</span>
            </button>

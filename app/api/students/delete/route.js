...
export async function POST(request) {
  ...
  await db
    .delete(schema.clinical_logs)
    .where(eq(schema.clinical_logs.student_id, id));
  await db
    .delete(schema.exam_forms)
    .where(eq(schema.exam_forms.student_id, id));
  await db
    .delete(schema.internship_postings)
    .where(eq(schema.internship_postings.student_id, id));

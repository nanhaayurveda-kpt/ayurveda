          ...
          <div className="flex flex-wrap gap-2 p-4">
            {Object.entries(subjectCount)
              ...
              .map(([sub, cnt]) => (
                <span
                  key={sub}
                  className="bg-green-50 text-green-700 text-xs font-medium px-3 py-1.5 rounded-full border border-green-100"
                >
                  {sub}: {cnt}
                </span>
              ))}
                          ...
                          <div className="flex flex-wrap gap-1">
                            {byDay[day]
                              ...
                              .map((p) => (
                                <span
                                  key={p.id}
                                  className="bg-green-50 border border-green-100 text-green-700 text-xs px-2 py-0.5 rounded"
                                >

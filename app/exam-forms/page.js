  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        ...
        <div className="bg-green-50 rounded-xl p-3 border border-green-100">
          <p className="text-xs text-green-600 font-medium">Exam Fee Paid</p>
          <p className="text-xl font-bold text-green-700 mt-1">
            {summary.fee_paid}
          </p>
        </div>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {form.exam_fee_paid === 1 && (
                      <span className="shrink-0 px-2 py-0.5 text-xs rounded-full font-medium bg-green-100 text-green-700">
                        Fee Paid
                      </span>
                    )}
                  </div>
                ...
                <div className="ml-3 shrink-0 flex flex-col gap-1 items-end">
                  ...
                  {form.form_status !== "pending" && (
                    <ResetForm
                      id={form.id}
                      feePaid={form.exam_fee_paid ? "1" : "0"}
                    />
                  )}{" "}
                </div>
              </div>

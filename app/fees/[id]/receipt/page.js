  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 max-w-2xl mx-auto print:shadow-none print:border-none">
        <div className="text-center border-b-2 border-green-600 p-6">
          {settings.logo_url && (
            <img
          ...
          <div className="mt-3 inline-block bg-green-600 text-white text-xs font-bold px-4 py-1 rounded-full">
            FEE PAYMENT RECEIPT
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="border border-gray-200 rounded-lg p-4 mb-5">
            <h3 className="text-xs font-bold text-green-600 uppercase mb-3">
              Student Details
            </h3>
          ...
          <div className="border-t border-gray-200 pt-5 flex justify-between items-end">
            <div className="text-xs text-gray-400">
              <p>Powered by Ayurveda College Software</p>

    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-lg font-bold text-green-700 mb-1">Ayurveda College</p>
        ...
        <form action="/api/professor-login" method="POST" className="space-y-4">
          ...
          <button type="submit"
            className="w-full bg-green-600 text-white py-2.5 rounded-lg hover:bg-green-700 text-sm font-medium">
            Login
          </button>
        </form>
      </div>

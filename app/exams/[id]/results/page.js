                      ...
                      <tr key={student.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          ...
                          <input
                            ...
                            max={exam.max_marks}
                            placeholder="0"
                            className="w-20 border border-gray-300 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                          />
                        </td>
                        ...
                        <td className="px-4 py-3">
                          <input
                            ...
                            className="w-28 border border-gray-300 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                          />
                        </td>
                      </tr>
                    );
